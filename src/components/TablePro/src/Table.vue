<!--
 * @Author: ZHENG
 * @Date: 2022-04-30 14:36:20
 * @LastEditors: ZHENG
 * @LastEditTime: 2022-04-30 14:55:01
 * @FilePath: \admin\src\components\TablePro\src\Table.vue
 * @Description:
-->
<template>
    ...
    return {
      ...
      handleFiltersChange(filters) {
        if (!loadingRef.value) {
          ...
          query(paginationReactive.page, paginationReactive.pageSize, column1Reactive.sortOrder, filterValues).then(
            data => {
