...
declare namespace AuthRoute {
  ...
  type RouteKey =
    ...
    | 'course_courseInfo'
    | 'course_courseDetail'
    | 'course_coursePreview'
    | 'course_courseReport'
    | 'course_coursePractice'
		| 'course_courseType'
    | 'test'
    | 'test_baseManager'
    | 'test_baseType'
    ...
    | 'test_addExam'
    | 'learnAnalysis'
    | 'learnAnalysis_testAnalysis'
    | 'learnAnalysis_testAnalysis_personalTest'
    | 'learnAnalysis_questAnalysis'
    | 'learnAnalysis_questAnalysis_personalTest'
    | 'learnAnalysis_examAnalysis'
    | 'learnAnalysis_examAnalysis_personalTest'
		| 'experiment'
		| 'experiment_experimentManager'
    | 'system'
    | 'system_menu'
    | 'system_dictionary'
		| 'virtualizer'
		| 'virtualizer_VMTemplateManage'
		| 'setting'
		| 'setting_baseSetting'
    | 'user'
    | 'user_student'
