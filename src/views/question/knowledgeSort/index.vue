 ...
 * @LastEditors: ZHENG
 * @LastEditTime: 2022-05-23 13:36:33
 * @FilePath: \work\src\views\question\knowledgeSort\index.vue
 * @Description:
-->
<template>
...
import { searchCouserInfo, getcourseCategoryList, getClassList, getCollegeLegistt, getMenuList } from '@/service';
