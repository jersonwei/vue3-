 ...
 * @LastEditors: ZHENG
 * @LastEditTime: 2022-04-30 10:25:08
 * @FilePath: \admin\src\views\system-view\login\components\PwdLogin\index.vue
 * @Description:
-->
<template>
...
import { useSmsCode, useImageReady } from '@/hooks';
...
const changeImgCode = async () => {
  ...
  const pics = [`${http.url}/captcha.jpg?t=${Math.random()}`];
