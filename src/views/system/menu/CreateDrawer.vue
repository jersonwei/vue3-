<!--
 * @Author: ZHENG
 * @Date: 2022-05-04 17:20:21
 * @LastEditors: ZHENG
 * @LastEditTime: 2022-05-16 15:27:10
 * @FilePath: \work\src\views\system\menu\CreateDrawer.vue
 * @Description:
-->
<template>
  <n-drawer v-model:show="isDrawer" :width="width" :placement="placement">
    <n-drawer-content :title="title" closable>
      <n-form ref="formRef" :model="formParams" :rules="rules" label-placement="left" :label-width="100">
